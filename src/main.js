...
$(document).ready(function() {
  $('#search').submit(function(event) {
    ...
    let promise = new Promise(function(resolve, reject) {
     ...
     let url = `https://api.betterdoctor.com/2016-03-01/doctors?query=${issue}&location=47.5994832%2C-122.3338803%2C20&user_location=47.5994832%2C-122.3338803&skip=0&limit=100&user_key=${process.env.exports.apiKey}`;
   ...
   promise.then(function(response) {
     ...
     result.forEach(function(doctor) {
       ...
       practices.forEach(function(practice) {
         console.log(practice.within_search_area);
